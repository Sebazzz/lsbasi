...
private:
	...
	void convert_value(ast::expression_value& expr_value, builtin_type_symbol& expr_type) const;
...
public:
	...
	void convert_value(eval_value& eval_value) const override;
	void change_type(eval_value& eval_value) const override;
};